        ...
        <div style={{ position: 'relative' }}>
          <button
            ...
            style={{
              ...
              borderRadius: 2, padding: '0.375rem 0.75rem 0.375rem 0.375rem',
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)', textTransform: 'capitalize', letterSpacing: '0.03em' }}>{user?.role}</div>
            </div>
            <ChevronDown size={14} color="var(--text-muted)" style={{ transform: menuOpen ? 'rotate(180deg)' : 'none', transition: 'transform 0.3s' }} />
          </button>

          {menuOpen && (
            <div style={{
              position: 'absolute', top: 'calc(100% + 8px)', right: 0,
              background: 'var(--bg-card)', backgroundImage: 'var(--paper-texture)',
              border: '1px solid var(--border)',
              borderRadius: 3, minWidth: 200, padding: '0.5rem',
              boxShadow: '0 8px 24px rgba(44, 48, 46, 0.12)', zIndex: 200,
